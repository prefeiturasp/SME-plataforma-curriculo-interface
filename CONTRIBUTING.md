...
[issues do GitHub](https://github.com/prefeiturasp/SME-plataforma-curriculo-interface/issues). Porém antes
...
[criar uma nova issue](https://github.com/prefeiturasp/SME-plataforma-curriculo-interface/issues/new). 
...
Para criar seu pedido de recurso basta
[criar uma nova issue](https://github.com/prefeiturasp/SME-plataforma-curriculo-interface/issues/new) usando
o label **recurso**.
/new) usando
o label **recurso**.
...
ao nosso [código de conduta](https://github.com/prefeiturasp/SME-plataforma-curriculo-interface/blob/pamnovalli-patch-1/CODEOFCONDUCT.md) antes de realizar qualquer
...
- Ajude com a documentação do projeto [nossa wiki](https://github.com/prefeiturasp/SME-plataforma-curriculo-interface/wiki);
