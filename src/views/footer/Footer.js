...
import iconLicense from '../../images/by-nc-sa.svg';
    ...
    return (
      <footer className={styles.wrapper}>
        ...
        <div className={styles.license}>
          ...
          <p>Todo o conteúdo desta plataforma está licenciado com uma Licença <a href="http://creativecommons.org/licenses/by-nc-sa/4.0">Creative Commons - Atribuição-NãoComercial-CompartilhaIgual 4.0 Internacional</a>, exceto quando indicado de maneira diferente em conteúdos específicos. O código-fonte da plataforma também é aberto e está disponível no <a href="https://github.com/prefeiturasp/SME-plataforma-curriculo">GitHub</a></p>
        </div>
      </footer>
    );
  }
