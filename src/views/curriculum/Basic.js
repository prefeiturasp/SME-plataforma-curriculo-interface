      ...
      <Page>
          ...
          <div className="row">
            <div className="col-md-8 offset-md-2">
              <p className={styles.doubleLineHeight}>
                ...
                longo dos últimos anos. O movimento de atualização do currículo
                envolveu mais de 43 mil estudantes e 16 mil professores ao longo
                de 2017, em paralelo às discussões sobre a Base Nacional Comum
                Curricular (BNCC) que se faziam nacionalmente, de forma a ser a
                primeira cidade a lançar o documento em sua versão já alinhada
                às diretrizes nacionais. Conheça abaixo sua estrutura e navegue
                pela versão interativa.
              </p>
            </div>
          </div>
        </header>
        ...
        <ul className={styles.list}>
          ...
          <li className={styles.learningObjectives}>
            ...
            <NavLink className={styles.btn} to="/objetivos-de-aprendizagem">
              Explore e encontre sequências
            </NavLink>
          </li>
        </ul>
