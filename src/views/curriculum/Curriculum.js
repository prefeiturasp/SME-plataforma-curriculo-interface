      ...
      <section className={styles.wrapper}>
        ...
        <ul className={styles.list}>
          ...
          <li className={styles.knowledgeMatrix}>
            ...
            <p className={styles.doubleLineHeight}>A Matriz de Saberes tem como propósito formar cidadãos éticos, responsáveis e solidários que fortaleçam uma sociedade mais inclusiva, democrática, próspera e sustentável. Aqui você pode conhecer as dimensões da matriz e encontrar as sequências relacionadas.</p>
