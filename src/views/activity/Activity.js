          ...
          <div className="row">
            <div className={styles.description}>
              ...
              <div className="quill-question">
                ...
                <p className="quill-source">Fonte: Adaptado de <em>A Surdez de Beethoven, o Desafio de um Gênio</em></p>
              </div>
              <div className="quill-exercise">
